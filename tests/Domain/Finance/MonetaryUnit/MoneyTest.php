...
final class MoneyTest extends TestCase
{
    ...
    {
        $this->assertSame($sum, $term->add($addend)->nominal()->main());
    }
    ...
    {
        $this->assertSame($difference, $minuend->subtract($subtrahend)->nominal()->main());
    }
    ...
    {
        $this->assertSame($product, $multiplier->multiply($multiplicand)->nominal()->main());
    }
    ...
    {
        $this->assertSame($quotient, $dividend->divide($divisor)->nominal()->main());
    }
